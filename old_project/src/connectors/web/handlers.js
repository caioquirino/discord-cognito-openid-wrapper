...
module.exports = {
  ...
  authorize: (req, res) =>
    responder(res).redirect(
      `https://discord.com/api/oauth2/authorize?client_id=${req.query.client_id}&scope=${req.query.scope}&state=${req.query.state}&response_type=${req.query.response_type}`
    ),
